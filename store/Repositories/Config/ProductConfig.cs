    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                ...
                new Product() { ProductId = 8, CategoryId=1, ImageUrl="/images/8.jpg", ProductName = "Xp", Price = 45445, ShowCase = true },
                new Product() { ProductId = 9, CategoryId=1, ImageUrl="/images/9.jpg", ProductName = "Samsung", Price = 465445, ShowCase = true },
                new Product() { ProductId = 10, CategoryId=1, ImageUrl="/images/10.jpg", ProductName = "Hp", Price = 4545, ShowCase = true }
            );
        }
    }
}